	...
	<div>
		<div class="head_top">
			...
			<div class="top_tittle">
				<h4><strong>历史红包</strong></h4>
			</div>
		</div>
		<div class="middle">
			<ul class="red_packet" v-for="v in hongbao">
				<li>
					<div class="li_left">
						<h3>
							<span>￥</span><span>{{v.amount}}</span><span>.0</span>
						</h3>
...
<script>
	...
	export default {
		...
		created() {
			LishiHongbao(this.$store.state.achieves.id).then(
				data => {
					this.hongbao = data
					console.log(data)
				}).catch(error => {
